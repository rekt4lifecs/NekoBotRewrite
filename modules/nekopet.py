...
class NekoPet(commands.Cog):
    ...
    async def neko_play(self, ctx):
        ...
        if random.randint(1, 2) == 1:
            ...
            await ctx.send("<a:rainbowNekoDance:462373594555613214> | **Your neko is now happy :3 (%s attention)**" % am)
        else:
    ...
    async def neko_feed(self, ctx):
        ...
        try:
            ...
            await ctx.send("<a:rainbowNekoDance:462373594555613214> | **Paid %s for your nekos food!**" % payamount)
        except Exception as e:
            await ctx.send("❌ | " + "**Failed to remove balance. `%s`" % e)
    ...
    async def neko_train(self, ctx):
        ...
        if random.randint(1, 4) == 1:
            ...
            await ctx.send("**Your neko learnt new tricks owo (%s score)**" % am)
        else:
            await ctx.send("**Your neko doesn't feel like playing, maybe try again later.**")
