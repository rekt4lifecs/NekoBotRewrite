...
class Fun:
    ...
    async def shitpost(self, ctx):
        ...
        shitpost = [
            ...
            "I pwedge of awwegiance to the fwag of the Unyited States of Amewica and to the wepubwic fow which it stands onye nyation undew god indivisibwe with wibewty and justice fow aww.",
            ...
            "Can we stop with the owo twanswatow gawbage??? Posting knyown copypastas with an owo twanswation isn’t unyique, it doesn’t make you wook coow, it just makes you seem wike a tawentwess hack. I sewiouswy cannyot expwain to you guys how mad I am. If you stiww have any decency in you, stop posting owo twanswations into w/copypasta and join the wesistance ;;w;; Viva wa wevowution ;;w;; ",
            ...
            "I was onwy nyinye yeaws owd. I wuvd Shwek so much, I had aww the mewchandise and movies. I'd pway to Shwek evewy nyight befowe I go to bed, thanking fow the wife I've been given. \"Shwek is wuv\", I wouwd say, \"Shwek is wife\". My dad heaws me and cawws me a faggot. I knyew he was just jeawous fow my devotion of Shwek. I cawwed him a cunt. He swaps me and sends me to go to sweep. I'm cwying nyow and my face huwts. I way in bed and it's weawwy cowd. A wawmth is moving towawds me. I feew something touch me. It's Shwek. I'm so happy. He whispews in my eaw, \"This is my swamp\". He gwabs me with his powewfuw ogwe hands, and puts me on my hands and knyees. I spwead my ass-cheeks fow Shwek. He penyetwates my butthowe. It huwts so much, but I do it fow Shwek. I can feew my butt teawing as my eyes stawt to watew. I push against his fowce. I want to pwease Shwek. He woaws a mighty woaw, as he fiwws my butt with his wuv. My dad wawks in. Shwek wooks him stwaight in the eye, and says, \"It's aww ogwe nyow\". Shwek weaves thwough my window. Shwek is wuv. Shwek is wife.﻿",
    ...
    @commands.command()
    @commands.cooldown(1, 5, commands.BucketType.user)
    async def magik(self, ctx, user:discord.Member):
        """Magikify a member"""
        await ctx.trigger_typing()
        async with aiohttp.ClientSession() as cs:
            async with cs.get("https://nekobot.xyz/api/imagegen?type=magik&image={}".format(user.avatar_url_as(format="png"))) as r:
                res = await r.json()
        if not res["success"]:
            return await ctx.send(f"**Failed to generate, {res['message']}**")
        em = discord.Embed(color=0xDEADBF)
