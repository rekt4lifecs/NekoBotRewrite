...
| find | Audio | Find audio |
| now | Audio | Whats playing now |
| skip | Audio | Skip a song |
| disconnect | Audio | Disconnect from the voice channel |
| repeat | Audio | Repeat a song. |
| play | Audio | Play a song |
| volume | Audio | Change the volume |
| pause | Audio | Pause a song |
| queue | Audio | Show the queue |
| stop | Audio | Stop a song |
| shuffle | Audio | Shuffle a queue |
| upload | Audio | Upload a file to store. |
| redeem | Audio | Redeem your token |
| trapcard | Audio | Trap a user |
| donate | Audio | Donate! |
...
| weebify | Fun | Weebify a image **notices bulge** OwO *Whats this* |
...
| widen | Fun | widen an image |
| doujin | NSFW | OwO Whats this |
| yandere | NSFW | Get a random image from yandere |
| cumsluts | NSFW | Creamy images |
| gonewild | NSFW | Gonewild subreddit |
| thighs | NSFW | Get thighs of 3d wamen |
| lewdkitsune | NSFW | Lewd a kitsune, not a loli! |
| 4k | NSFW | 4k grill |
| boobs | NSFW | I wonder what this does |
| girl | NSFW | 3D < 2D women btw |
| phsearch | NSFW | Search for loods |
| hentai | NSFW | Get 2D wamen pics owO |
| ass | NSFW | :eyes: |
| anal | NSFW | :zoomeyes: |
| pgif | NSFW | :ultraeyes: |
| bigboobs | NSFW | :hyperthink: |
| nsfw | NSFW | Make a channel NSFW or disable NSFW |
| rule34 | NSFW | Get an image from rule34 |
| owo | Reactions | OwO |
...
| neko | Reactions | Get a neko or a lood neko in an nsfw channel owo |
